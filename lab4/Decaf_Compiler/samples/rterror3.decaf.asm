  ...
  _L1:
	...
	# _tmp9 = 120
	  li $t3, 120		# load constant value 120 into $t3
	# _tmp10 = 0
  ...
  _L2:
	# _tmp19 = _tmp9 * _tmp11
	  lw $t0, -44($fp)	# load _tmp9 from $fp-44 into $t0
	  lw $t1, -52($fp)	# load _tmp11 from $fp-52 into $t1
	  mul $t2, $t0, $t1	
	...
	# (save modified registers before flow of control change)
	  ...
	  sw $t3, -88($fp)	# spill _tmp20 from $t3 to $fp-88
