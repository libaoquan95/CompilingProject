  ...
  main:
	...
	# (save modified registers before flow of control change)
	  ...
	  sw $t2, -28($fp)	# spill _tmp6 from $t2 to $fp-28
	  jal _PrintInt      	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp7 = 21
	...
	# (save modified registers before flow of control change)
	  ...
	  sw $t1, -36($fp)	# spill _tmp8 from $t1 to $fp-36
	  sw $t2, -40($fp)	# spill _tmp9 from $t2 to $fp-40
	  jal _PrintInt      	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp10 = 345
	  li $t0, 345		# load constant value 345 into $t0
	# _tmp11 = 56
	  li $t1, 56		# load constant value 56 into $t1
	...
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# _tmp13 = 82
	  li $t0, 82		# load constant value 82 into $t0
	# _tmp14 = 9
	  li $t1, 9		# load constant value 9 into $t1
	...
	# (save modified registers before flow of control change)
	  ...
	  sw $t1, -60($fp)	# spill _tmp14 from $t1 to $fp-60
	  sw $t2, -64($fp)	# spill _tmp15 from $t2 to $fp-64
	  jal _PrintInt      	# jump to function
	# PopParams 4
	  add $sp, $sp, 4	# pop params off stack
	# EndFunc
