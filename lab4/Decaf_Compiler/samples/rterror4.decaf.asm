  ...
  main:
	...
	# (save modified registers before flow of control change)
	  ...
	  beqz $t5, _L0	# branch if _tmp6 is zero 
	# Goto _L1
  ...
  _L1:
	# _tmp8 = _tmp3 * _tmp5
	  lw $t0, -20($fp)	# load _tmp3 from $fp-20 into $t0
	  lw $t1, -28($fp)	# load _tmp5 from $fp-28 into $t1
	  mul $t2, $t0, $t1	
	# _tmp9 = _tmp8 + _tmp5
	  add $t3, $t2, $t1	
	# PushParam _tmp9
	...
	# _tmp11 = "shouldn't get here"
	  .data			# create string constant marked with label
	  _string2: .asciiz "shouldn't get here"
	  .text
	...
	# LCall _PrintString
	# (save modified registers before flow of control change)
	  sw $t0, -48($fp)	# spill _tmp10 from $t0 to $fp-48
