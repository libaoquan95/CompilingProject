  ...
  main:
	...
	# PushParam _tmp3
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -28($fp)	# load _tmp3 from $fp-28 into $t0
	...
	# PushParam _tmp6
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -40($fp)	# load _tmp6 from $fp-40 into $t0
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintInt
	  jal _PrintInt      	# jump to function
	# PopParams 4
	...
	# PushParam _tmp7
	  subu $sp, $sp, 4	# decrement sp to make space for param
	  lw $t0, -44($fp)	# load _tmp7 from $fp-44 into $t0
	  sw $t0, 4($sp)	# copy param value to stack
	# LCall _PrintInt
	  jal _PrintInt      	# jump to function
	# PopParams 4
	...
	# _tmp10 = _tmp3 + _tmp8
	  lw $t2, -28($fp)	# load _tmp3 from $fp-28 into $t2
	  add $t3, $t2, $t0	
	# PushParam _tmp10
	  subu $sp, $sp, 4	# decrement sp to make space for param
	...
	# LCall _PrintInt
	# (save modified registers before flow of control change)
	  sw $t1, -52($fp)	# spill _tmp9 from $t1 to $fp-52
